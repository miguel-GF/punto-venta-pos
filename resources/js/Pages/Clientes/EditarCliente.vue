    ...
    <div class="q-pa-md full-height">
      <q-card class="q-pa-md full-height overflow-auto">
        <div class="row col-12 justify-between q-mb-md">
          <div class="text-h4">Editar Cliente</div>
          <div class="q-my-auto">
...
export default {
  ...
  methods: {
    llenarDatosForm() {
      const { nombre_comercial, telefono, eslogan, correo, tipo_persona,
        razon_social, rfc, codigo_postal, domicilio_fiscal, correo_fiscal 
      } = this.cliente;
      this.form = {
    ...
    guardar() {
      ...
      this.$inertia.post("/clientes/editar/" + this.cliente.cliente_id, form);
    },
    limpiar() {
      this.$nextTick(() => {
